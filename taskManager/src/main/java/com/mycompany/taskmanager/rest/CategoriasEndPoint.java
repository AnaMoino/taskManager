...
import com.mycompany.taskmanager.dao.CategoriasDao;
...
public class CategoriasEndPoint {
    ...
    @Inject
    CategoriasDao categoriasService;
    ...
    public List<Categoria> listAll(@QueryParam("start") Integer startPosition,
        ...
        final List<Categoria> results = categoriasService.listAll(startPosition, maxResult);
        return results;
    }
    ...
    public Response update(@PathParam("id") Long id, Categoria entity) {
        ...
        try {
            entity = categoriasService.update(entity);
